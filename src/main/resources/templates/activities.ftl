        ...
        <div class="row" style="padding-top: 5%">
            <div class="col-md-4" style="padding-left: 10%;">
                <form method="post">
                    ...
                    <input class="mt-1" name="link" type="url" placeholder="https://example.com" pattern="https://.*">
                    <textarea class="mt-1" name="description" type="text" placeholder="Введите описание тренировки здесь"></textarea>
                    <br>
